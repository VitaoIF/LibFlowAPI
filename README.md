...
Método: POST
Rota: /books
Entrada (Request JSON): Atenção: A propriedade do título na entrada chama-se title.
{
...
Saída (Response JSON) - Status 201 Created: Atenção: Na resposta há particularidades nas nomenclaturas, como tittle e avaliable.
{
  "id": 1,
  "isbn": "978-85-359-0277-8",
...
Método: POST
Rota: /loans
Entrada (Request JSON): Lembre-se: readerId deve ser o UUID de um leitor e book deve ser o ID (Long) de um livro.
{
  "status": "APPROVED",
  "loanDate": "2024-04-27",
...
Saída (Response JSON) - Status 201 Created: Retorna o empréstimo consolidado com os dados internos do reader e do book.
{
  "id": 10,
  "status": "APPROVED",
  "loanDate": "2024-04-27",
